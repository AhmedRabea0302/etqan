...
<section>
    <div class="box-item">
        <div class="box-item-head">
            <h3 class="title">{{$evidence->title}}</h3>
            <i class="fa fa-angle-down"></i>
        </div><!-- End Box-Item-Head -->
        <div class="box-item-content">
            <form class="form" id="upload_form" method="POST" action="{{route('post-update-evidence-content', ['id' => $evidence->id])}}" enctype="multipart/form-data">
                @if(Session::has('m'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group ar">
                                <label>نص الدليل</label>
                                <input type="text" name="evidence" class="form-control" value="{{$evidence->title}}">
                            </div><!-- End Form-Group -->
                        </div><!-- End col -->
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="short_reply" class="form-control summernote" id="short_reply" cols="30" rows="6">{!! html_entity_decode($evidence->short_reply) !!}</textarea>
                            </div><!-- End Form-Group -->
                        </div><!-- End col -->
                        ...
                        <div class="col-md-12">
                            <div class="form-group ar">
                                ...
                                <textarea name="long_reply" class="form-control summernote" id="long_reply" cols="30" rows="10">{!! html_entity_decode($evidence->long_reply) !!}</textarea>
                            </div><!-- End Form-Group -->
                        </div><!-- End col -->
                                    ...
                                    <div style="margin:auto">
                                        @if($evidence->video_url)
                                            <video  height="300" controls  style="border: 3px solid #033230;">
                                                <source src="{{url('storage/uploads/videos/evidences/1.mp4')}}">
                                            </video>
                                        @else 
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="book-cont">
                                        <h3>اسم الكتاب: 
                                            @if($evidence->book_url)<strong><a target="_blank" href="{{url('storage/uploads/books/evidences/AAT BIO.pdf')}}">{{$book_name}}</a></strong><i class="fa fa-file"></i>
                                            @else
                                                لا يوجد كتاب مٌرفق!
                                            @endif
                                        </h3>
                ...
                <div class="form-action">
                    <div class="row">
                        <div class="col-xs-12">
                            <button class="custom-btn pull-right" type="submit"> تعديل الدليل</button>
                        </div><!--End Col-->
                    </div><!--End Row-->
                </div><!--End Form-action-->
            </form><!-- End row -->
