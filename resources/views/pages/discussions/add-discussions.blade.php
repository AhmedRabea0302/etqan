...
<section>
    <div class="box-item">
        <div class="box-item-head">
            <h3 class="title">إضافة مناظرة جديد</h3>
            <i class="fa fa-angle-down"></i>
        </div><!-- End Box-Item-Head -->
        <div class="box-item-content">
            <form class="form" id="upload_form" method="POST" action="{{route('post-add-discussion')}}" enctype="multipart/form-data">
                @if(Session::has('m'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control parnt_nodes" name="parent_id">
                                    <option value="0">مناظرة رئيسية</option>
                                    @foreach ($discussions as $discussion)
                                        <option value="{{$discussion->id}}">{!!html_entity_decode( $discussion->title)!!}</option>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control objlevel" name="level" id="objlevel">
                                    <option value="0">مناظرة فرعية</option>
                                    <option value="1">مناظرة نهائية</option>
                                </select>
                            </div><!--End Form-group-->
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group ar">
                                ...
                                <textarea name="discussion" class="form-control" id="" cols="30" rows="4"></textarea>
                            </div><!-- End Form-Group -->
                        </div><!-- End col -->
                ...
                <div class="form-action">
                    <div class="row">
                        <div class="col-xs-12">
                            <button class="custom-btn pull-right" type="submit">إضافة مناظرة</button>
                        </div><!--End Col-->
                    </div><!--End Row-->
                </div><!--End Form-action-->
            </form><!-- End row -->
