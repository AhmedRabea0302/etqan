...
<section>
    <div class="box-item">
        ...
        <div class="box-item-content">
            <form class="form" id="upload_form" method="POST" action="{{route('post-update-suspicion-content', ['id' => $suspicion->id])}}" enctype="multipart/form-data">
                @if(Session::has('m'))
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="book-cont">
                                        <h3>اسم الكتاب: 
                                            @if($suspicion->book_url)<strong><a target="_blank" href="{{url('storage/uploads/books/suspicions/AAT BIO.pdf')}}">{{$book_name}}</a></strong><i class="fa fa-file"></i>
                                            @else
                                                لا يوجد كتاب مٌرفق!
                                            @endif
                                        </h3>
