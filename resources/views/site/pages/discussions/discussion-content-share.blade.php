                    ...
                    <div class="leftbox">
                        <div class="row">
                            <div class="subject-header col-md-12">
                                <h2> @if($discussion) {!! $discussion->title !!} @endif </h2>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="subject-content">
                                   @if($discussion)  {!! $discussion->short_reply !!} @endif
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="subject-content">
                                    @if($discussion)  {!! $discussion->long_reply !!} @endif
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="book-cont">
                                        <h3>اسم الكتاب: 
                                            @if($discussion->book_url)<strong><a target="_blank" href="{{url('storage/uploads/books/suspicions/AAT BIO.pdf')}}" class="no-book">{{$book_name}}</a></strong><i class="no-book fa fa-file"></i>
                                            @else
                                                لا يوجد كتاب مٌرفق!
                                            @endif
                                        </h3>
