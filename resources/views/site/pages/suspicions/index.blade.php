                    ...
                    <div class="row">
                        <div class="add-comment-form">
                            <form action="" method="POST">
                                ...
                                @if(!auth()->guard('auth-site')->check())
                                    <p class="lead"> 
                                        للتمكن من إضافة تعليق من فضلك قم بتسجيل الدخول أولا! <br>
    ...
    <script>
        ...
        $('tr td').on('click', function(event) {
            ...
            if($leaf == 1 ) {
                ...
                // document.querySelector('.add-favorite').setAttribute('data-id', $id);
        ...
        $('.add-comment-form form').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: '{{url('suspicion-add-comment')}}', // This is what I have updated
        ...
        let addReply = function(replyText, replytParent, replyCommentGetter) {
            ...
            $.ajax({
                type: "POST",
                url: '{{url('/suspicion-add-reply')}}', // This is what I have updated
        ...
        $('.share-content').on('click', function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: '{{url('/nosrah-suspicion-content')}}/' + $id,
                type: 'GET',
            }).done(() => {
                window.open(`nosrah-suspicion-content/${$id}`, '_blank');
            }).error(() => {
